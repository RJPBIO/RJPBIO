...
export const P = [
  ...
  ph:[{l:"Entrada Vagal",r:"0–30s",s:0,e:30,k:"Respira box: 4 dentro. 4 sostén. 4 fuera. 4 vacío.",i:"Cierra los ojos suavemente. Inhala por la nariz 4 segundos llenando el abdomen. Mantén 4 segundos sin tensión. Exhala por la boca 4 segundos vaciando completamente. Sostén vacío 4 segundos. Repite un ciclo más al mismo ritmo. Tu sistema nervioso ya está respondiendo.",iExec:[
    {from:0,to:10,text:"Cierra los ojos. Lleva la respiración al abdomen, sin tensión."},
    {from:10,to:30,text:"El sistema ya está bajando."}
  ],sc:"Box breathing 4-4-4-4 activa complejo vagal ventral, reduce frecuencia cardíaca en 15-20s",ic:"breath",br:{in:4,h1:4,ex:4,h2:4}},
  {l:"Descarga Cognitiva",r:"30–90s",s:30,e:90,k:"Identifica el peso. ¿Depende de ti? Actúa o suelta.",i:"Sin abrir los ojos, mantén la respiración box suave. Identifica el pensamiento que más pesa. Pregúntate: ¿depende de mí? Si sí, elige una micro-acción para los próximos 30 minutos. Si no, di internamente 'lo suelto'. Siente cómo el peso se alivia. Sigue respirando al mismo ritmo sin analizar — solo decide y suelta.",iExec:[
    {from:0,to:20,text:"Identifica el peso."},
    {from:20,to:40,text:"¿Depende de ti? Si sí: una acción concreta. Si no: \"lo suelto\"."},
    {from:40,to:60,text:"Respira. Siente cómo se alivia."}
  ],sc:"Decisión binaria interrumpe rumiación del córtex cingulado anterior, reduce carga del córtex prefrontal",ic:"mind",br:{in:4,h1:4,ex:4,h2:4}},
  {l:"Dirección y Cierre",r:"90–120s",s:90,e:120,k:"Una acción clara. Visualízala. Abre con dirección.",i:"Mantén la respiración estable. Pregúntate: ¿cuál es la única acción que hace todo lo demás más fácil? Visualízala con detalle — qué haces, dónde, cómo. Siente la certeza. En la última exhalación, abre los ojos lentamente. Lleva esa claridad contigo.",iExec:[
    {from:0,to:15,text:"Una sola acción — la que facilita todo lo demás."},
    {from:15,to:30,text:"Visualízala: qué haces, dónde, cómo. En la última exhalación, abres los ojos."}
  ],sc:"Foco unidireccional libera dopamina hacia corteza prefrontal dorsolateral. Visualización activa vías motoras",ic:"focus",br:{in:4,h1:4,ex:4,h2:4}}]},
