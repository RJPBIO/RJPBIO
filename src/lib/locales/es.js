export const es = {
  ...
  session: {
    ...
    delta: {
      ...
      verifiedUplift: "Tu HRV subió",
      verifiedDrop: "Tu HRV bajó",
      steady: "Tu sistema se mantuvo estable",
      unverifiedHrv: "HRV registrado",
      moodOnly: "Cambio reportado",
      timeOnly: "Sesión registrada",
      subVerified: "Variabilidad parasimpática · cambio verificado",
      subSteady: "El cambio fue menor al ruido medible (MDC95)",
      subUnverified: "Necesitamos 7+ lecturas previas para verificar",
      subSubjective: "Variabilidad parasimpática registrada",
      chipVerified: "MDC95",
      chipSteady: "Sin cambio significativo",
      chipUnverified: "Sin verificar",
      msUnit: "ms",
    },
  },
  offline: {
  ...
  protocols: {
    ...
    "10": { n: "Sensory Wake",               sb: "Activación somatosensorial fina" },
    "11": { n: "Body Anchor",                sb: "Anclaje propioceptivo" },
    "12": { n: "Neural Ascension",           sb: "Claridad ejecutiva" },
  ...
  programsData: {
    ...
    "focus-sprint": {
      ...
      rationale: "Protocolos de enfoque requieren un substrato autonómico estable. Arrancar con coherencia cardíaca calibra el sistema nervioso; recalibración visual + ascenso mental preparan la corteza prefrontal; Lightning Focus y Sensory Wake son los picos — aplicables solo cuando ya hay base.",
    },
    "burnout-recovery": {
      n: "Burnout Recovery",
    ...
    "executive-presence": {
      ...
      rationale: "Presencia ejecutiva no es calma pura (aburrida) ni energía pura (ansiosa) — es la paradoja acero+calma. Arco de 10 días alternando Grounded Steel, Steel Core Reset, Body Anchor y Reset Ejecutivo para consolidar el callback 'inquebrantable' como estado operativo repetible.",
    },
  },
};
