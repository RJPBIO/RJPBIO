...
ph:[{l:"Steel Breath",r:"0–20s",s:0,e:20,k:"Llena. Sostén. Explota. Resetea."Inhala profundamente 4 segundos llenando el abdomen. Mantén 2 segundos creando presión interna. Exhala EXPLOSIVAMENTE por la boca — todo el aire de golpe, como si apagaras 50 velas. Repite 3 veces. Siente el reset en tu sistema.",sc:"El exhale explosivo resetea el sistema nervioso autónomo por completo",ic:"breath",br:{in:4,h1:2,ex:2,h2:0}},
{l:"Núcleo de Acero",r:"20–60s",s:20,e:60,k:"Core activado. Respira con fuerza interna."Activa tu abdomen al 30-40% de tu fuerza máxima. No contengas la respiración — respira normalmente con el abdomen activado. Mantén 10 segundos. Suelta 5 segundos. Repite 2 veces. Siente la fuerza emocional que viene del centro.",sc:"La activación del core genera sensación de fuerza emocional y estabilidad",ic:"body",br:null},
...
ph:[{l:"Encendido Pulmonar",r:"0–20s",s:0,e:20,k:"Inhala profundo. Exhala en 5 pulsos cortos."Inhala profundamente 4 segundos. Al exhalar, hazlo en 5 micro-pulsos cortos — como 5 pequeñas ráfagas de aire rápidas. Esto activa el diafragma de forma diferente a la respiración normal. Repite 3 ciclos.",sc:"Activa la coordinación sensoriomotora fina del sistema respiratorio",ic:"breath",br:{in:4,h1:0,ex:4,h2:0}},
...
ph:[{l:"Vacío Inicial",r:"0–15s",s:0,e:15,k:"Apaga todo. Vacío interior. Silencio."Inhala suavemente 4 segundos. Exhala largo 6 segundos. Haz una pausa de 2 segundos sin aire. Di internamente: 'Apago todo.' Siente cómo el silencio interno se expande.",sc:"Inhibe la amígdala y reduce la actividad del circuito de alarma",ic:"breath",br:{in:4,h1:0,ex:6,h2:2}},
{l:"Pulso del Núcleo",r:"15–30s",s:15,e:30,k:"Dos manos. Dos pulsos. Una conexión."Coloca una mano en el pecho, otra en el ombligo. Siente ambos pulsos. Percibe la distancia entre ellos. Nota cómo late tu corazón — cada latido es tu sistema funcionando. Quédate ahí, solo sintiendo.",sc:"Genera coherencia entre el corazón y el cerebro entérico",ic:"body",br:null},
{l:"Realineación Neural",r:"30–55s",s:30,e:55,k:"Ojos en cruz. Sonido imaginario. Recalibra."Mueve solo los ojos: derecha, izquierda, arriba, abajo. 3 segundos en cada dirección. Ahora imagina un sonido suave moviéndose de oreja a oreja. La combinación de movimiento ocular y sonido imaginario recalibra las redes bilaterales.",sc:"Activa redes bilaterales del cerebro, similar al sueño REM",ic:"focus",br:null},
...
ph:[{l:"Golpe de Silencio",r:"0–10s",s:0,e:10,k:"Silencio total. Apago todo. Ahora."Inhala lento 4 segundos. Exhala largo 6 segundos. Sostén el vacío 2 segundos. Di internamente: 'Apago todo.' Siente cómo tu mente se aquieta en un instante.",sc:"Modo silencio neural, reduce actividad del cortex prefrontal lateral",ic:"breath",br:{in:4,h1:0,ex:6,h2:2}},
{l:"Presencia Doble",r:"10–25s",s:10,e:25,k:"Dos puntos. Doble presencia. Ínsula activa."Mano derecha en el pecho, izquierda en el abdomen. Siente ambos puntos simultáneamente. Percibe la distancia entre ellos. Nota cuál se mueve más con tu respiración. Esta doble atención entrena la ínsula cerebral.",sc:"Activa la ínsula y el precúneo, centros de conciencia corporal",ic:"body",br:null},
...
export default function BioIgnicion(){
  ...
  function timerTap(){H("tap");if(ts==="idle"){go();}else if(ts==="running")pa();else if(ts==="paused"){setTs("running");H("go");speak("continúa");}}
  ...
  {tab==="ignicion"&&postStep==="none"&&countdown===0&&!compFlash&&(<div style={{padding:"14px 20px 180px"}}>
    ...
    {nfcCtx&&ts==="idle"&&<div style={{display:"flex",alignItems:"center",gap:8,padding:"10px 14px",marginBottom:12,background:nfcCtx.type==="salida"?IND+"08":ac+"08",borderRadius:14,border:`1.5px solid ${nfcCtx.type==="salida"?IND+"20":ac+"20"}`,animation:"fi .4s"}}>
      ...
      <div><div style={{fontSize:7,fontWeight:800,letterSpacing:2,color:nfcCtx.type==="salida"?"#6366F1":ac,textTransform:"uppercase"}}>{nfcCtx.type==="salida"?"SESIÓN DE SALIDA":"SESIÓN DE ENTRADA"}</div>
      ...
      {nfcCtx.company&&<div style={{fontSize:7,color:t3,marginTop:1}}>{nfcCtx.company}</div>}</div>
    </div>}
