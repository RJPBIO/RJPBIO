...
const COPY = {
  es: {
    ...
    entBody:
      "Cada control representa postura activa o documentada. Los artefactos formales (SOC 2 posture document, DPA, BAA-ready) se entregan bajo NDA a través de Trust Center.",
  ...
  en: {
    ...
    entBody:
      "Each control represents an active or documented posture. Formal artifacts (SOC 2 posture document, DPA, BAA-ready) are delivered under NDA via Trust Center.",
    entSso: "SSO · SAML 2.0 + OIDC",
