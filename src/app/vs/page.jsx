...
const COPY = {
  es: {
    ...
    items: [
      ...
      {
        slug: null,
        competitor: "Calm for Business",
        status: "soon",
        statusLabel: "Q3 2026",
        oneLiner: "Audio de bienestar vs pre-shift medible. Mismo pricing, diferente promesa.",
        angle: "Content library · B2C-first",
      },
      {
        slug: null,
        ...
        status: "soon",
        statusLabel: "Q4 2026",
        oneLiner: "Coaching + terapia vs fisiología operacional. Complementarios, no sustitutivos.",
        angle: "Coaching + therapy platform",
      },
    ],
  ...
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        status: "soon",
        statusLabel: "Q3 2026",
        oneLiner: "Wellness audio vs measurable pre-shift. Same pricing band, different promise.",
        angle: "Content library · B2C-first",
      },
      {
        slug: null,
        ...
        status: "soon",
        statusLabel: "Q4 2026",
        oneLiner: "Coaching + therapy vs operational physiology. Complementary, not substitutive.",
        angle: "Coaching + therapy platform",
      },
    ],
