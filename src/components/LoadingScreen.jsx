/**
 * LoadingScreen — Bio-branded splash
 * Shows while the app initializes.
 * The triple-ring SVG IS the brand mark.
 */
    ...
    <div style={{
      ...
      <svg width="56" height="56" viewBox="0 0 56 56" style={{ animation: "pu 1.8s ease infinite" }}>
        ...
        <circle cx="28" cy="28" r="17" fill="none" stroke="#6366F1" strokeWidth="1.5" strokeDasharray="5 4"
          style={{ animation: "innerRing 8s linear infinite" }} />
        <circle cx="28" cy="28" r="6" fill="#059669" opacity=".5">
          <animate attributeName="r" values="5;7;5" dur="2s" repeatCount="indefinite" />
        </circle>
      </svg>
      <div style={{
        fontSize: 10, fontWeight: 800, color: "#4B5568",
